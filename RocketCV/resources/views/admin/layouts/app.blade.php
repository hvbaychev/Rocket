...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/png" href="{{ asset('assetsAdmin/black') }}/img/favicon.png">
        <!-- Fonts -->
        ...
        <link href="{{ asset('assetsAdmin/css/theme.css') }}" rel="stylesheet" />
    </head>
    <body class="{{ $class ?? '' }}">
            <div class="wrapper">
        ...
        <script src="{{ asset('assetsAdmin/js/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
        <!--  Google Maps Plugin    -->
        ...
        <script src="{{ asset('assetsAdmin/js/black-dashboard.min.js?v=1.0.0') }}"></script>
        <script src="{{ asset('assetsAdmin/js/theme.js') }}"></script>
        @stack('js')
